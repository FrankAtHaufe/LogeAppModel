...
namespace LogeAppModel
{
	...
	public class ClassHauptmenue : AppModelBase
	{
		#region Constructors

		public ClassHauptmenue()
		{
			Name = @"ClassHauptmenue";
			LexwareProfessionalWindow = new LexwareProfessionalWindowNode(this);
			RebuildDescriptions();
			
		}

		public ClassHauptmenue(ITestObject contextTestObject)
		{
			Name = @"ClassHauptmenue";
			LexwareProfessionalWindow = new LexwareProfessionalWindowNode(contextTestObject, this);
			RebuildDescriptions();
		...
		public LexwareProfessionalWindowNode LexwareProfessionalWindow { get; private set; }
	
		#endregion
	
		#region Inner Classes
	
		public sealed class LexwareProfessionalWindowNode : WindowNodeBase
		{
			#region Constructors
		
			public LexwareProfessionalWindowNode(AppModelBase applicationModel) : base(applicationModel)
			{
				MenLeisteUiObject = new MenLeisteUiObjectNode(this, applicationModel);
				DisplayName = @"Lexware professional";
			}
		
			public LexwareProfessionalWindowNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
			{
				MenLeisteUiObject = new MenLeisteUiObjectNode(this, applicationModel);
				DisplayName = @"Lexware professional";
			}
			...
			protected override HP.LFT.SDK.StdWin.WindowDescription CreateDescription()
			{
				return new HP.LFT.SDK.StdWin.WindowDescription
				{
					...
					WindowTitleRegExp = As.RegExp(@"Lexware.*")
				};
			}
			...
			public MenLeisteUiObjectNode MenLeisteUiObject { get; private set; }
		
			#endregion
		
			#region Inner Classes
		
			public sealed class MenLeisteUiObjectNode : UiObjectNodeBase
			{
				#region Constructors
			
				public MenLeisteUiObjectNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
					DisplayName = @"Menueleiste";
				}
				...
				protected override HP.LFT.SDK.StdWin.UiObjectDescription CreateDescription()
				{
					...
					{
						WindowClassRegExp = @"XTPToolBar",
						WindowTitleRegExp = @"Menüleiste"
					};
				}
